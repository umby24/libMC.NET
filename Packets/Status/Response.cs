...
namespace libMC.NET.Packets.Status {
    public class Response : Packet {
        ...
        public Response(ref Minecraft mc) {
            ...
            versionName = jsonObj["version"]["name"];
            ProtocolVersion = jsonObj["version"]["protocol"];

            MaxPlayers = jsonObj["players"]["max"];
            OnlinePlayers = jsonObj["players"]["online"];
            ...
            MOTD = jsonObj["description"];
            string imageString = jsonObj["favicon"];
